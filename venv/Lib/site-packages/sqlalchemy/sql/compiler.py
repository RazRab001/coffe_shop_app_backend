...
class Linting(IntEnum):
    ...
    this feature currently includes support for flagging cartesian product
    in SQL statements.
    ...
    """Collect data on FROMs and cartesian product and gather into
    'self.from_linter'"""
    ...
    """Warn for cartesian product; combines COLLECT_CARTESIAN_PRODUCTS
    and WARN_LINTING"""
